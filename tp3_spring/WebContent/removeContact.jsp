...
<form name="myForm" method="post" action="RemoveContact/EntrepriseCriteria" onsubmit="">
    <br/>
...
<form name="myForm" method="post" action="RemoveContact/ContactCriteria" onsubmit="">
    <br/>
    <input type="submit" value="Search"> 
    <input type="reset"  value="Clear">
    <label for="lab">search by Criteria (with like)</label>
