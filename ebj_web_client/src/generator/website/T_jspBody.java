...
public class T_jspBody
{
  ...
  protected final String TEXT_3 = "</h4></div>" + NL + "  </div>" + NL + "  " + NL + "  <div class=\"sidebar\">" + NL + "<a href=\"menuAddContact\">add contact</a><br>" + NL + "<a href=\"removeContact.jsp\">remove contact</a><br>" + NL + "<a href=\"menuSearchPage\">search contact</a><br>" + NL + "<a href=\"updateContact.jsp\">update contact</a><br>" + NL + "<a href=\"ClearTable\">clear table</a><br>" + NL + "<a href=\"ShowAllContact\">showTable</a><br>" + NL + "  </div>" + NL + "  " + NL + "  <div class=\"mainBody\" style=\"overflow:auto\">" + NL + "  <%=request.getParameter(\"dbOutput\")  == null ? \"\" : request.getParameter(\"dbOutput\")%>" + NL + "  <%=request.getParameter(\"dbOutputRaw\")  == null ? \"\" : request.getParameter(\"dbOutputRaw\")%>";
